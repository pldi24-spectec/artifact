...
relation Step_pure: `%*~>%*`(admininstr*, admininstr*)
  ;; 6-reduction.watsup:19.1-20.24
  rule unreachable:
    `%*~>%*`([UNREACHABLE_admininstr], [TRAP_admininstr])

  ;; 6-reduction.watsup:22.1-23.19
  rule nop:
    `%*~>%*`([NOP_admininstr], [])

  ;; 6-reduction.watsup:25.1-26.24
  rule drop {val : val}:
    `%*~>%*`([(val <: admininstr) DROP_admininstr], [])

  ;; 6-reduction.watsup:29.1-31.16
  ...
  ;; 6-reduction.watsup:111.1-112.60
  ...
  ;; 6-reduction.watsup:115.1-117.33
  ...
  ;; 6-reduction.watsup:128.1-130.46
  ...
  ;; 6-reduction.watsup:133.1-135.37
  ...
  ;; 6-reduction.watsup:137.1-139.40
  ...
  ;; 6-reduction.watsup:142.1-143.70
  ...
  ;; 6-reduction.watsup:146.1-148.48
  ...
  ;; 6-reduction.watsup:150.1-152.54
  ...
  ;; 6-reduction.watsup:159.1-161.28
...
relation Step_read: `%~>%*`(config, admininstr*)
  ...
  ;; 6-reduction.watsup:98.1-102.52
  ...
  ;; 6-reduction.watsup:189.1-191.32
  ...
  ;; 6-reduction.watsup:219.1-222.14
  ...
  ;; 6-reduction.watsup:224.1-228.15
  ...
  ;; 6-reduction.watsup:231.1-233.73
  ...
  ;; 6-reduction.watsup:235.1-238.14
  ...
  ;; 6-reduction.watsup:240.1-245.15
  ...
  ;; 6-reduction.watsup:247.1-251.15
  ...
  ;; 6-reduction.watsup:254.1-256.72
  ...
  ;; 6-reduction.watsup:258.1-261.14
  ...
  ;; 6-reduction.watsup:263.1-267.15
  ...
  ;; 6-reduction.watsup:274.1-276.53
  ...
  ;; 6-reduction.watsup:278.1-280.71
  ...
  ;; 6-reduction.watsup:282.1-284.45
  ...
  ;; 6-reduction.watsup:286.1-288.55
  ...
  ;; 6-reduction.watsup:325.1-328.14
  ...
  ;; 6-reduction.watsup:330.1-334.15
  ...
  ;; 6-reduction.watsup:337.1-339.69
  ...
  ;; 6-reduction.watsup:341.1-344.14
  ...
  ;; 6-reduction.watsup:346.1-351.15
  ...
  ;; 6-reduction.watsup:353.1-357.15
  ...
  ;; 6-reduction.watsup:360.1-362.70
  ...
  ;; 6-reduction.watsup:364.1-367.14
  ...
  ;; 6-reduction.watsup:369.1-373.15
...
relation Step: `%~>%`(config, config)
  ...
  ;; 6-reduction.watsup:197.1-199.32
  ...
  ;; 6-reduction.watsup:207.1-209.47
  ...
  ;; 6-reduction.watsup:211.1-212.64
  ...
  ;; 6-reduction.watsup:295.1-297.35
  ...
  ;; 6-reduction.watsup:299.1-301.45
  ...
  ;; 6-reduction.watsup:303.1-305.50
  ...
  ;; 6-reduction.watsup:313.1-315.41
  ...
  ;; 6-reduction.watsup:317.1-318.59
...
def val_ref : ref -> val
  def {x : reftype} val_ref(REF.NULL_ref(x)) = REF.NULL_val(x)
  def {x : funcaddr} val_ref(REF.FUNC_ADDR_ref(x)) = REF.FUNC_ADDR_val(x)
  def {x : hostaddr} val_ref(REF.HOST_ADDR_ref(x)) = REF.HOST_ADDR_val(x)
...
relation Instr_ok: `%|-%:%`(context, instr, functype)
  ...
  rule global.get {C : context, t : valtype, x : idx, w0 : ()?}:
    `%|-%:%`(C, GLOBAL.GET_instr(x), `%->%`([], [t]))
    -- if (x < |C.GLOBAL_context|)
    -- where `MUT%?%`(w0, t) = C.GLOBAL_context[x]
...
def grow_table : (tableinst, nat, ref) -> tableinst?
  ;; 4-runtime.watsup:170.1-174.36
  def {i : nat, i' : nat, j : nat, n : n, r : ref, r'* : ref*, rt : reftype, ti : tableinst, ti' : tableinst} grow_table(ti, n, r) = ?(ti')
    -- where {TYPE `%%`(`[%..%]`(i, j), rt), ELEM r'*{r'}} = ti
    -- where i' = (|r'*{r'}| + n)
    -- where ti' = {TYPE `%%`(`[%..%]`(i', j), rt), ELEM r'*{r'} :: r^n{}}
    -- Tabletype_ok: `|-%:OK`(ti'.TYPE_tableinst)
  def {x : (tableinst, nat, ref)} grow_table(x) = ?()
...
def grow_memory : (meminst, nat) -> meminst?
  ;; 4-runtime.watsup:175.1-179.34
  def {b* : byte*, i : nat, i' : nat, j : nat, mi : meminst, mi' : meminst, n : n} grow_memory(mi, n) = ?(mi')
    -- where {TYPE `%I8`(`[%..%]`(i, j)), DATA b*{b}} = mi
    -- where i' = ((|b*{b}| / (64 * $Ki)) + n)
    -- where mi' = {TYPE `%I8`(`[%..%]`(i', j)), DATA b*{b} :: 0^((n * 64) * $Ki){}}
    -- Memtype_ok: `|-%:OK`(mi'.TYPE_meminst)
  def {x : (meminst, nat)} grow_memory(x) = ?()
...
def allocfuncs : (store, moduleinst, func*) -> (store, funcaddr*)
  ...
  ;; 7-module.watsup:42.1-44.50
  def {fa : funcaddr, fa'* : funcaddr*, func : func, func'* : func*, m : moduleinst, s : store, s_1 : store, s_2 : store} allocfuncs(s, m, [func] :: func'*{func'}) = (s_2, [fa] :: fa'*{fa'})
    -- where (s_1, fa) = $allocfunc(s, m, func)
    -- where (s_2, fa'*{fa'}) = $allocfuncs(s_1, m, func'*{func'})
}
...
def allocglobals : (store, globaltype*, val*) -> (store, globaladdr*)
  ...
  def {ga : globaladdr, ga'* : globaladdr*, globaltype : globaltype, globaltype'* : globaltype*, s : store, s_1 : store, s_2 : store, val : val, val'* : val*} allocglobals(s, [globaltype] :: globaltype'*{globaltype'}, [val] :: val'*{val'}) = (s_2, [ga] :: ga'*{ga'})
    ...
    -- where (s_2, ga'*{ga'}) = $allocglobals(s_1, globaltype'*{globaltype'}, val'*{val'})
}
...
def alloctable : (store, tabletype) -> (store, tableaddr)
  ;; 7-module.watsup:57.1-58.59
  def {i : nat, j : nat, rt : reftype, s : store, ti : tableinst} alloctable(s, `%%`(`[%..%]`(i, j), rt)) = (s[TABLE_store =.. [ti]], |s.TABLE_store|)
    -- where ti = {TYPE `%%`(`[%..%]`(i, j), rt), ELEM REF.NULL_ref(rt)^i{}}
...
def alloctables : (store, tabletype*) -> (store, tableaddr*)
  ...
  ;; 7-module.watsup:62.1-64.53
  def {s : store, s_1 : store, s_2 : store, ta : tableaddr, ta'* : tableaddr*, tabletype : tabletype, tabletype'* : tabletype*} alloctables(s, [tabletype] :: tabletype'*{tabletype'}) = (s_2, [ta] :: ta'*{ta'})
    -- where (s_1, ta) = $alloctable(s, tabletype)
    -- where (s_2, ta'*{ta'}) = $alloctables(s_1, tabletype'*{tabletype'})
}
...
def allocmem : (store, memtype) -> (store, memaddr)
  ;; 7-module.watsup:67.1-68.62
  def {i : nat, j : nat, mi : meminst, s : store} allocmem(s, `%I8`(`[%..%]`(i, j))) = (s[MEM_store =.. [mi]], |s.MEM_store|)
    -- where mi = {TYPE `%I8`(`[%..%]`(i, j)), DATA 0^((i * 64) * $Ki){}}
...
def allocmems : (store, memtype*) -> (store, memaddr*)
  ...
  def {ma : memaddr, ma'* : memaddr*, memtype : memtype, memtype'* : memtype*, s : store, s_1 : store, s_2 : store} allocmems(s, [memtype] :: memtype'*{memtype'}) = (s_2, [ma] :: ma'*{ma'})
    ...
    -- where (s_2, ma'*{ma'}) = $allocmems(s_1, memtype'*{memtype'})
}
...
def allocelems : (store, reftype*, ref**) -> (store, elemaddr*)
  ...
  ;; 7-module.watsup:82.1-84.55
  def {ea : elemaddr, ea'* : elemaddr*, ref* : ref*, ref'** : ref**, rt : reftype, rt'* : reftype*, s : store, s_1 : store, s_2 : store} allocelems(s, [rt] :: rt'*{rt'}, [ref*{ref}] :: ref'*{ref'}*{ref'}) = (s_2, [ea] :: ea'*{ea'})
    -- where (s_1, ea) = $allocelem(s, rt, ref*{ref})
    -- where (s_2, ea'*{ea'}) = $allocelems(s_2, rt'*{rt'}, ref'*{ref'}*{ref'})
}
...
def allocdatas : (store, byte**) -> (store, dataaddr*)
  ...
  ;; 7-module.watsup:92.1-94.50
  def {byte* : byte*, byte'** : byte**, da : dataaddr, da'* : dataaddr*, s : store, s_1 : store, s_2 : store} allocdatas(s, [byte*{byte}] :: byte'*{byte'}*{byte'}) = (s_2, [da] :: da'*{da'})
    -- where (s_1, da) = $allocdata(s, byte*{byte})
    -- where (s_2, da'*{da'}) = $allocdatas(s_1, byte'*{byte'}*{byte'})
}
...
def allocmodule : (store, module, externval*, val*, ref**) -> (store, moduleinst)
  ;; 7-module.watsup:98.1-135.54
  def {byte*^n_data : byte*^n_data, da* : dataaddr*, datamode?^n_data : datamode?^n_data, ea* : elemaddr*, elemmode?^n_elem : elemmode?^n_elem, export* : export*, expr_1^n_global : expr^n_global, expr_2*^n_elem : expr*^n_elem, externval* : externval*, fa* : funcaddr*, fa_ex* : funcaddr*, func^n_func : func^n_func, ga* : globaladdr*, ga_ex* : globaladdr*, globaltype^n_global : globaltype^n_global, i_data^n_data : nat^n_data, i_elem^n_elem : nat^n_elem, i_func^n_func : nat^n_func, i_global^n_global : nat^n_global, i_mem^n_mem : nat^n_mem, i_table^n_table : nat^n_table, import* : import*, m : moduleinst, ma* : memaddr*, ma_ex* : memaddr*, memtype^n_mem : memtype^n_mem, module : module, n_data : n, n_elem : n, n_func : n, n_global : n, n_mem : n, n_table : n, ref** : ref**, rt^n_elem : reftype^n_elem, s : store, s_1 : store, s_2 : store, s_3 : store, s_4 : store, s_5 : store, s_6 : store, start? : start?, ta* : tableaddr*, ta_ex* : tableaddr*, tabletype^n_table : tabletype^n_table, val* : val*, xi* : exportinst*} allocmodule(s, module, externval*{externval}, val*{val}, ref*{ref}*{ref}) = (s_6, m)
    -- where fa_ex*{fa_ex} = $funcs(externval*{externval})
    -- where ga_ex*{ga_ex} = $globals(externval*{externval})
    -- where ma_ex*{ma_ex} = $mems(externval*{externval})
    -- where ta_ex*{ta_ex} = $tables(externval*{externval})
    -- where `MODULE%*%*%*%*%*%*%*%?%*`(import*{import}, func^n_func{func}, GLOBAL(globaltype, expr_1)^n_global{expr_1 globaltype}, TABLE(tabletype)^n_table{tabletype}, MEMORY(memtype)^n_mem{memtype}, `ELEM%%*%?`(rt, expr_2*{expr_2}, elemmode?{elemmode})^n_elem{elemmode expr_2 rt}, `DATA%*%?`(byte*{byte}, datamode?{datamode})^n_data{byte datamode}, start?{start}, export*{export}) = module
    -- where da*{da} = (|s.DATA_store| + i_data)^(i_data<n_data){i_data}
    -- where ea*{ea} = (|s.ELEM_store| + i_elem)^(i_elem<n_elem){i_elem}
    -- where ma*{ma} = (|s.MEM_store| + i_mem)^(i_mem<n_mem){i_mem}
    -- where ta*{ta} = (|s.TABLE_store| + i_table)^(i_table<n_table){i_table}
    -- where ga*{ga} = (|s.GLOBAL_store| + i_global)^(i_global<n_global){i_global}
    -- where fa*{fa} = (|s.FUNC_store| + i_func)^(i_func<n_func){i_func}
    -- where xi*{xi} = $instexport(fa_ex*{fa_ex} :: fa*{fa}, ga_ex*{ga_ex} :: ga*{ga}, ta_ex*{ta_ex} :: ta*{ta}, ma_ex*{ma_ex} :: ma*{ma}, export)*{export}
    -- where m = {FUNC fa_ex*{fa_ex} :: fa*{fa}, GLOBAL ga_ex*{ga_ex} :: ga*{ga}, TABLE ta_ex*{ta_ex} :: ta*{ta}, MEM ma_ex*{ma_ex} :: ma*{ma}, ELEM ea*{ea}, DATA da*{da}, EXPORT xi*{xi}}
    -- where (s_1, fa*{fa}) = $allocfuncs(s, m, func^n_func{func})
    -- where (s_2, ga*{ga}) = $allocglobals(s_1, globaltype^n_global{globaltype}, val*{val})
    -- where (s_3, ta*{ta}) = $alloctables(s_2, tabletype^n_table{tabletype})
    -- where (s_4, ma*{ma}) = $allocmems(s_3, memtype^n_mem{memtype})
    -- where (s_5, ea*{ea}) = $allocelems(s_4, rt^n_elem{rt}, ref*{ref}*{ref})
    -- where (s_6, da*{da}) = $allocdatas(s_5, byte*{byte}^n_data{byte})
...
def instantiation : (store, module, externval*) -> config
  ...
  def {data* : data*, elem* : elem*, elemmode?* : elemmode?*, export* : export*, externval* : externval*, f : frame, f_init : frame, func^n_func : func^n_func, global* : global*, globaltype* : globaltype*, i^n_elem : nat^n_elem, i_func^n_func : nat^n_func, import* : import*, instr_1** : instr**, instr_2*** : instr***, instr_data* : instr*, instr_elem* : instr*, j^n_data : nat^n_data, m : moduleinst, m_init : moduleinst, mem* : mem*, module : module, n_data : n, n_elem : n, n_func : n, ref** : ref**, reftype* : reftype*, s : store, s' : store, start? : start?, table* : table*, val* : val*, x? : idx?} instantiation(s, module, externval*{externval}) = `%;%*`(`%;%`(s', f), $admininstr_instr(instr_elem)*{instr_elem} :: $admininstr_instr(instr_data)*{instr_data} :: CALL_admininstr(x)?{x})
    ...
    -- (Exec_expr_const: `%~>%`(`%;%*`(`%;%`(s, f_init), $admininstr_instr(instr_2)*{instr_2}), $val_ref(ref)))*{instr_2 ref}*{instr_2 ref}
    -- (Exec_expr_const: `%~>%`(`%;%*`(`%;%`(s, f_init), $admininstr_instr(instr_1)*{instr_1}), val))*{instr_1 val}
    -- where (s', m) = $allocmodule(s, module, externval*{externval}, val*{val}, ref*{ref}*{ref})
...
def invocation : (store, funcaddr, val*) -> config
  ...
  def {expr : expr, f : frame, fa : funcaddr, functype : functype, k : nat, m : moduleinst, n : n, s : store, val^n : val^n, valtype* : valtype*, valtype_param^n : valtype^n, valtype_res^k : valtype^k} invocation(s, fa, val^n{val}) = `%;%*`(`%;%`(s, f), $admininstr_val(val)^n{val} :: [CALL_ADDR_admininstr(fa)])
    ...
    -- where `%->%`(valtype_param^n{valtype_param}, valtype_res^k{valtype_res}) = functype
